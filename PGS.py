...
\033[1;37m----------------------------------------------
 ...
 GITHUB     : PRABESH EXE 
 OWNER      :  PRABESH - PAUDEL
 VERSION    :\u001b[32m 0.1\033[1;37m
 TOOL       :   FILE x PUBLIC 
\033[1;37m----------------------------------------------
...
def psw():
	os.system('clear')
	banner()
	print(" [\u001b[36m>\033[1;37m] TERO ACCOUNT LAI PASSWORD DEA  " )
	linex()
	upsw = input(" [\u001b[36m•\033[1;37m] PASSWORD HAL MUGI: " )
...
def name(): 
	...
	print('\033[1;37m----------------------------------------------')
	animation(' >> YOUR GIRLFRIEND HAS BEEN CHANGED ')
	exit()
try:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[PRASH-XWD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
